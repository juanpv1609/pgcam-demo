...
class HabitacionesController extends Zend_Controller_Action
{
    ...
    public function select_piso(){
        ...
        if (!$datosarea) {
            ...
            $Listaarea .= '<label for="comboArea">Seleccione una especialidad:</label>';
        ...
        if (!$datos) {
            ...
            foreach ($datos as $item):
                ...
                $cadena .= '<td>Activa</td>
                    ...
                    <button type="button" class="btn btn-outline-warning btn-sm " onclick="editarModal('. $item->habitacion_id .')" >
